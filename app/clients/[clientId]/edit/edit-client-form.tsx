  ...
  return (
    <>
      ...
      >
        ...
        <div className="mb-8">
          <h2 className="text-xl font-bold text-black mb-6">Detail Acara</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Ceremony Date */}
            <div>
        ...
        {/* Addresses Section */}
        <div className="mb-8">
          <h2 className="text-xl font-bold text-black mb-6">Alamat</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Bride's Address */}
            <div>
              ...
              <textarea
                ...
                required
                rows={3}
                className="w-full mt-2 rounded-lg border border-[#d4b896] bg-white px-4 py-3 text-black focus:ring-2 focus:ring-[#d4b896]/50 focus:outline-none focus:border-[#d4b896] placeholder:text-gray-500 transition-colors resize-none"
              />
            </div>
        ...
        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row items-center justify-end gap-4 pt-6 border-t border-[#d4b896]">
          <Link
            href="/clients"
            className="w-full sm:w-auto px-6 py-3 text-center text-gray-600 hover:text-black transition-colors"
          >
            Cancel
          </Link>
          <Button
