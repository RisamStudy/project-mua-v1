          ...
          {upcomingAppointments.map((apt) => {
            ...
            return (
              <div
                ...
                className="flex gap-4 p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer border border-gray-200"
              >
                <div
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-600 truncate">
                    {apt.description ||
                      (apt.client ? apt.client.groomName : "No description")}
                  </p>
