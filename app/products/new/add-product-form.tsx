  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        {/* Product Photo */}
        <div className="bg-white border border-[#d4b896] rounded-xl p-6">
          <h2 className="text-xl font-bold text-black mb-2">Product Photo</h2>
          <p className="text-sm text-gray-600 mb-6">
            Upload a product photo (automatically compressed for optimal
            storage).
          </p>

          <div className="border-2 border-dashed border-[#d4b896] rounded-xl p-8 text-center hover:border-[#c4a886] transition-colors cursor-pointer">
            <input
              type="file"
              accept="image/*"
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-black mb-2">
                      <span className="text-[#d4b896]">Click to upload</span> or
                      drag and drop
                    </p>
        ...
        {/* Product Details */}
        <div className="bg-white border border-[#d4b896] rounded-xl p-6">
          <h2 className="text-xl font-bold text-black mb-2">Product Details</h2>
          <p className="text-sm text-gray-600 mb-6">
