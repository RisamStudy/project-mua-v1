    ...
    <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
        ...
        <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-[#2a2a2a] space-y-2 sm:space-y-3">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
            ...
            <Input
              ...
              placeholder="0"
              className="w-full sm:w-48 bg-[#1a1a1a] text-sm sm:text-base"
            />
          </div>
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full mt-2 rounded-lg border border-[#2a2a2a] bg-[#1a1a1a] px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-white focus:ring-2 focus:ring-[#d4b896]/50 focus:outline-none resize-none"
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-end gap-3 sm:gap-4">
        <button
          type="button"
          onClick={() => router.back()}
          className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base text-gray-400 hover:text-white transition-colors"
        >
          Batal
        </button>
        <Button
