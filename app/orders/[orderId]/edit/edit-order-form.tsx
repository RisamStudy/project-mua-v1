    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white border border-[#d4b896] rounded-xl p-6">
          <h2 className="text-xl font-bold text-black mb-6">Informasi Klien</h2>
        ...
        <div className="bg-white border border-[#d4b896] rounded-xl p-6">
                  ...
                  <tr key={item.id} className="border-b border-[#d4b896]">
                    <td className="py-3">
                      <Input
                        ...
                        required
                        className="bg-white border-[#d4b896] text-black"
                      />
                    </td>
                    ...
                    <td className="py-3 px-2">
                      <div className="px-4 py-2 bg-gray-100 rounded-lg text-black">
          ...
          <div className="mt-6 pt-6 border-t border-[#d4b896]">
