  ...
  return (
    <div className={`${className}`}>
      <div className="flex flex-col">
        ...
        >
          <span className="material-symbols-outlined text-green-600 text-lg group-hover:scale-110 transition-transform">
            chat
          </span>
          <span className="font-medium text-gray-800">{phoneNumber}</span>
          <span className="text-xs text-gray-500 ml-2">WhatsApp</span>
        </button>
      </div>
      {children}
    </div>
